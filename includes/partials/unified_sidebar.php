...
<aside class="studio-sidebar">
  ...
  <?php if ($role === 'creator'): ?>
  <a href="<?= BASE_URL ?>/creator/" class="studio-nav-item <?= ($current_page === 'index.php' && str_contains($_SERVER['PHP_SELF'], '/creator/')) ? 'active' : '' ?>">&#127968; Dashboard</a>
  ...
  <a href="<?= BASE_URL ?>/creator/reels.php" class="studio-nav-item <?= $current_page === 'reels.php' ? 'active' : '' ?>">&#128241; My Reels</a>
  <?php endif; ?>
