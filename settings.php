            ...
            if ($taken) {
                ...
                if (strlen($current_pass) > 0 || strlen($new_pass) > 0 || strlen($confirm_pass) > 0) {
                    if (!verify_password($current_pass, $user['password'])) {
                        ...
                        $updateData['password'] = hash_password($new_pass);
                    }
                }
          ...
          <div class="card">
            ...
            <div class="form-group">
              ...
              <div style="position:relative">
                <input class="form-input" type="password" name="current_password" placeholder="Verify current password" style="padding-right:44px">
                <button type="button" class="password-toggle-btn" style="position:absolute;right:10px;top:50%;transform:translateY(-50%);color:var(--text2);display:flex;padding:4px;cursor:pointer" onclick="togglePasswordVisibility(this)" aria-label="Toggle password visibility">
            ...
            <div class="form-group">
              ...
              <div style="position:relative">
                <input class="form-input" type="password" name="new_password" placeholder="Min 6 characters" style="padding-right:44px">
                <button type="button" class="password-toggle-btn" style="position:absolute;right:10px;top:50%;transform:translateY(-50%);color:var(--text2);display:flex;padding:4px;cursor:pointer" onclick="togglePasswordVisibility(this)" aria-label="Toggle password visibility">
                  <svg class="eye-open" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                  <svg class="eye-closed" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="display:none"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
                </button>
            ...
            <div class="form-group">
              ...
              <div style="position:relative">
                <input class="form-input" type="password" name="confirm_password" placeholder="Re-type new password" style="padding-right:44px">
                <button type="button" class="password-toggle-btn" style="position:absolute;right:10px;top:50%;transform:translateY(-50%);color:var(--text2);display:flex;padding:4px;cursor:pointer" onclick="togglePasswordVisibility(this)" aria-label="Toggle password visibility">
                  <svg class="eye-open" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                  <svg class="eye-closed" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="display:none"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
                </button>
