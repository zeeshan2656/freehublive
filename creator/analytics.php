      ...
      <div class="table-wrap">
        <table>
          ...
          <tr>
            ...
            <td class="text-sm" style="text-align:right"><?= format_number((int)$v['views']) ?></td>
            <td class="text-sm" style="text-align:right"><?= format_number((int)$v['likes']) ?></td>
            <td class="text-sm" style="text-align:right"><?= format_number((int)$v['comments_count']) ?></td>
            <td class="text-sm" style="text-align:right"><?= format_duration((int)$v['watch_time']) ?></td>
          </tr>
          <?php endforeach; ?>
          </tbody>
        </table>
